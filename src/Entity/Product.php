...
class Product
{
     ...
     * @Assert\Length(min=3, max=255, minMessage="Le nom du prosuit doit avoir au moins 3 caractères")
     * 
     */
    private $name;
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Url(message="La photo principale doit être une Url calide")
